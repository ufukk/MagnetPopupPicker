...
// MagnetPopupPicker
#define COCOAPODS_POD_AVAILABLE_MagnetPopupPicker
#define COCOAPODS_VERSION_MAJOR_MagnetPopupPicker 0
#define COCOAPODS_VERSION_MINOR_MagnetPopupPicker 1
#define COCOAPODS_VERSION_PATCH_MagnetPopupPicker 0
